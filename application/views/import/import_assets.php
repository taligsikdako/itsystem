...
<?php endif; ?>
    ...
    <div class="form-group">
          <a class="" href="<?php echo base_url('msasset/ms_assets'); ?>">View All Assets</a>
    </div>
		<br />
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"<?php echo base_url(); ?>import/load_msassets",
			method:"POST",
	...
	$('#import_csv').on('submit', function(event){
		...
		$.ajax({
			url:"<?php echo base_url(); ?>import/import_msassets",
			method:"POST",
